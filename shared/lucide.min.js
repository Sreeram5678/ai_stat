/**
 * AIStat Bundled Lucide Icons (CSP Compliant & Offline Ready)
 */
(function (global) {
  'use strict';
  ...
  const icons = {
    ...
    'scroll-text': '<path d="M8 21h12a2 2 0 0 0 2-2v-2H10v2a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v3h4"></path><path d="M19 17V5a2 2 0 0 0-2-2H4"></path><path d="M15 8h-5"></path><path d="M15 12h-5"></path>',
    'settings-2': '<line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="10" y1="21" x2="10" y2="12"></line><line x1="10" y1="8" x2="10" y2="3"></line><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><circle cx="20" cy="14" r="2"></circle><circle cx="10" cy="10" r="2"></circle><circle cx="4" cy="12" r="2"></circle>',
  ...
  function createIcons(options = {}) {
    ...
    elements.forEach(el => {
      ...
      // Copy any custom attributes if present
      Array.from(el.attributes).forEach(attr => {
        if (!['class', 'data-lucide'].includes(attr.name)) {
